...
export async function approveOwnershipRequest(requestId: string): Promise<void> {
  ...
  const venueData: Omit<Venue, 'id'> = {
    ...
    imageUrl: infraData.imageUrl || 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTjW-Mq-ylpMsJU7nzhOnD4_SmunuSU7QwsfA&s',
    category: 'sports',
    ...
    const defaults = [
      {
        ...
        imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTjW-Mq-ylpMsJU7nzhOnD4_SmunuSU7QwsfA&s",
      ...
      },
      {
        ...
        imageUrl: "https://en.reformsports.com/oxegrebi/2020/09/mini-futbol-sahasi-ozellikleri-ve-olculeri.jpg",
      ...
      },
      {
        ...
        imageUrl: "https://t4.ftcdn.net/jpg/18/59/23/45/360_F_1859234521_7Tq92Hx3DrR01H6zQQ4dFCmnhLlt7IMw.jpg",
      ...
      },
      {
        ...
        ownerId: null,
        infrastructureType: "government",
        imageUrl: "https://turftown.s3.ap-south-1.amazonaws.com/super_admin/tt-1724321381033.webp",
      ...
      },
      {
        ...
        ownerId: null,
        infrastructureType: "government",
        imageUrl: "https://t3.ftcdn.net/jpg/02/80/11/26/360_F_280112608_32mLVErazmuz6OLyrz2dK4MgBULBUCSO.jpg",
      ...
      },
      {
        ...
        imageUrl: "https://shivrajenterprise.com/wp-content/uploads/2025/08/kabaddi-playing-in-the-ground-image.webp",
      ...
      },
      {
        ...
        ownerId: null,
        infrastructureType: "park",
        imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRZ3DoT5EQiPMEWEvpcfvs4TuWsd_fT9lY6Vw&s",
