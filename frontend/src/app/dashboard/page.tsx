...
import { formatCurrency, formatDate, getSportEmoji, cn, getSportImage } from '@/shared/helpers/utils';
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {savedVenues.map((v) => (
                  <Link key={v.id} href={`/venues/${v.id}`} className="glass rounded-lg p-4 card-hover border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[8px_8px_0px_0px_#facc15] block">
                    ...
                    <img src={getSportImage(v.sport, v.id)} alt={v.name} className="w-full h-32 object-cover rounded-md mb-3 border-2 border-black" />
