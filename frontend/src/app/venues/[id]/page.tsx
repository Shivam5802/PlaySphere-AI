          ...
          if (isInfra) {
            ...
            if (active && dbInfra) {
              const mappedVenue: Venue = {
                ...
                imageUrl: dbInfra.imageUrl || 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTjW-Mq-ylpMsJU7nzhOnD4_SmunuSU7QwsfA&s',
  ...
  return (
    <div className="min-h-screen pt-20">
      ...
      <div className="relative h-72 md:h-96 overflow-hidden border-b-3 border-black">
        ...
        <img src={getSportImage(venue.sport, venue.id)} alt={venue.name} className="w-full h-full object-cover" />
